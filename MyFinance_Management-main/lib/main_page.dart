...
class _MainPageState extends State<MainPage> {
  ...
  final List<Widget> _pages = [
    const DashboardScreen(), // Replace with your actual implementation
    const AnalyticsPage(),
    const CategoryManagementPage(), // Replace with your actual implementation
    const AccountPage(), // Replace with your actual implementation
  ];
